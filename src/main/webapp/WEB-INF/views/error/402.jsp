    ...
    <div class="col-md-12">
        <div class="error-template">
            <h1>
                Oops!</h1>
            <h2>
                402 PaymentRequired</h2>
            <div class="error-details">
            <p>
            		<%java.text.DateFormat df = new java.text.SimpleDateFormat("dd-MM-yyyy HH:mm:ss"); %>
					Current Date: <%= df.format(new java.util.Date()) %>
            	</p><br>
                Sorry, The parameter to this message gives a specification of charging schemes acceptable. The client may retry the request with a suitable ChargeTo header!
            </div>
